...
The first step of the pipeline consists of the **collection and preparation of datasets** from [UniProtKB](https://www.uniprot.org/): 
...
**API URL:**
https://rest.uniprot.org/uniprotkb/search?format=json&query=%28%28fragment%3Afalse%29+AND+%28taxonomy_id%3A2759%29+AND+%28length%3A%5B40+TO+*%5D%29+AND+%28reviewed%3Atrue%29+AND+%28existence%3A1%29+AND+%28ft_signal_exp%3A*%29%29&size=500
...
- [LB2_Project__5_Pipeline.ipynb](./Data%20Collection/LB2_Project__5_Pipeline.ipynb)

This notebook:
- Downloads data from UniProtKB using REST API.
- Applies filtering functions for positive and negative sets.
- Exports datasets in both FASTA (sequences) and TSV (metadata).
...
| Negative Set | 20,615           | 20,615              | [FASTA](https://github.com/Martinaa1408/LB2_project_Group_5/blob/main/Data%20Collection/Negative%20Set/negative.fasta) · [TSV](https://github.com/Martinaa1408/LB2_project_Group_5/blob/main/Data%20Collection/Negative%20Set/negative.tsv) |
