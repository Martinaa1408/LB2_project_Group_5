...
| **3. Feature Selection (Random Forest)** | Train a Random Forest classifier (400 trees) and retain features above the median Gini importance. | 29→ 24 selected features |
...
After selection, **24 out of 29 total features** were retained for model training.
